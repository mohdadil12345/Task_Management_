  ...
  return (
    ...
    <>
      ...
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
        <li>
          All the crud operations like create, read, update, delete are handling
          in backend
        </li>
      ...
      <Accordion.Item eventKey="1">
        ...
        <li>
          Actions like adding tasks and fetching tasks (addtask and getTASKS)
          are dispatched using the dispatch function.
        </li>
      ...
      <Accordion.Item eventKey="2">
        ...
        <li>
          Users can input task details such as title, description, and priority
          using input fields and dropdown menus.
        </li>
        <li>
          When the user clicks the "Add Task" button (submitTaskData function),
          the task data is dispatched to Redux for state management. The task
          input fields are then cleared for adding a new task.
        </li>
      ...
      <Accordion.Item eventKey="5">
        ...
        <li>
          Users can select  on the task status (Completed or Pending) to toggle
          between the completed and pending states.
        </li>
        <li>
          A success toast is displayed after toggling the task status, informing
          the user whether the task was marked as completed or pending.
        </li>
      ...
      <Accordion.Item eventKey="6">
        ...
        <li>
          When the user clicks the "Register" button, the handleSignup function
          is triggered.{" "}
        </li>
        <li>
          The Redux action (signupUser) is imported using useDispatch hook from
          react-redux
        </li>
        </Accordion.Body>
      </Accordion.Item>
